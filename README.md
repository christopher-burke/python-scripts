...
|<a href="./cipher/reckon.py">cipher/reckon.py</a>|Reckon - simple substitution cipher.|
...
|<a href="./clipboard_history.py">clipboard\_history.py</a>|Clipboard History.|
...
|<a href="./correct_mistakes.py">correct\_mistakes.py</a>|Digital Mistakes kata.|
...
|<a href="./demo/shelve_.py">demo/shelve\_.py</a>|Shelve demo.|
...
|<a href="./external_ip.py">external\_ip.py</a>|External IP - using requests, get the extrenal IP Address.|
...
|<a href="./indenter.py">indenter.py</a>|Indentor using context manager.|
...
|<a href="./meaning.py">meaning.py</a>|Look up the meaning of a word.|
...
|<a href="./uplink/github.py">uplink/github.py</a>|GitHub consumer using uplink package.|
